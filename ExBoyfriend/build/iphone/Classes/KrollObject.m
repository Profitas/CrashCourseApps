...
//@interface ExBoyfriendObject : NSObject
//@end

@interface ExBoyfriendObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ExBoyfriendObject class]])
		{
			for (NSString *key in [[(ExBoyfriendObject*)o modules] allKeys])
			{
