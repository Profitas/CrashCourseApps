...
// in simulator we redefine to format for ExBoyfriend Developer console
...
{\
	NSString * exceptionName = [@"org.exboyfriend." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.exboyfriend";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIExBoyfriendNativeItemNone = -1, 
	UIExBoyfriendNativeItemSpinner = -2,
	UIExBoyfriendNativeItemProgressBar = -3,
	
	UIExBoyfriendNativeItemSlider = -4,
	UIExBoyfriendNativeItemSwitch = -5,
	UIExBoyfriendNativeItemMultiButton = -6,
	UIExBoyfriendNativeItemSegmented = -7,
	
	UIExBoyfriendNativeItemTextView = -8,
	UIExBoyfriendNativeItemTextField = -9,
	UIExBoyfriendNativeItemSearchBar = -10,
	
	UIExBoyfriendNativeItemPicker = -11,
	UIExBoyfriendNativeItemDatePicker = -12,
	
	UIExBoyfriendNativeItemInfoLight = -13,
	UIExBoyfriendNativeItemInfoDark = -14,
	
	UIExBoyfriendNativeItemDisclosure = -15,
	
	UIExBoyfriendNativeItemContactAdd = -16
};
